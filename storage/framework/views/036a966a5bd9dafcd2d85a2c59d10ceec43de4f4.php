            ...
            <div class="slider-desktop">
                    ...
                    <div style="background-image: url(public/theme/img/fingerprint.png); background-size: cover; background-position: right;">
                        ...
                        <div class="non-tablet-view">
                                    ...
                                    <div class="row portfolio-list sort-destination" data-sort-id="portfolio">
                                        <div class="col-md-6 isotope-item brands" style="padding: 5px 5px 0px 0px">
                                            <div class="card-flip card-flip-change-height1">
                                                <div class='frontCard invCard111' style="height: 510px">
                                                    <div class="card-container">
                                                        <div>
                                                            <h1 style="font-weight: 900; text-align: left; font-size: 46px; line-height: 43px; padding-top: 300px">WHY </br>STUDY AT</br> <span style="font-weight: bolder; font-size: 56px">CIRP?</span></h1></div>
                                                    </div>
                                                </div>

                                                <div class='backCard invCard2' style="background-color: #247cb7">
                                                    <div class="card-container2">
                                                        <h1 style="color: #FFFFFF; font-weight: bolder;">WHY STUDY AT CIRP?</h1>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-3 isotope-item websites" style="padding: 5px 5px">
                                            <div class="portfolio-item">
                                                <div class="card-flip" style="margin-bottom: 5px">
                                                    <div class='frontCard invCard03'>
                                                        <div class="card-container">
                                                            <div class="container-blue2">
                                                                <p style="font-weight: 600;  color: #FFF;font-size: 21px">Best Learning Resources</p>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div class='backCard invCard0002'>
                                                        <div class="card-container2">
                                                            <p style="text-align: center; padding-top: 200px">
                                                                <a href="Best-Learning-Resources.php">
                                                                    <button class="btn-hover1">Read More</button>
                                                                </a>
                                                            </p>
                                                        </div>
                                            ...
                                            <div class="portfolio-item">
                                                <div class="card-flip" style="margin-top: 5px">
                                                    <div class='frontCard invCard444'>
                                                        <div class="card-container">
                                                            <div class="container-blue3">
                                                                <p style="font-weight: 600;  color: #FFF;font-size: 21px">Ideal Staff : Student Ratio</p>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div class='backCard invCard0004'>
                                                        <div class="card-container2">
                                                            <p style="text-align: center; padding-top: 200px">
                                                                <a href="Ideal-Staff.php">
                                                                    <button class="btn-hover1">Read More</button>
                                                                </a>
                                                            </p>
                                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-3 isotope-item websites" style="padding: 5px 5px">
                                            <div class="portfolio-item">
                                                <div class="card-flip" style="margin-bottom: 5px">
                                                    <div class='frontCard invCard333'>
                                                        <div class="card-container">
                                                            <div class="container-blue2">
                                                                <p style="font-weight: 600;  color: #FFF;font-size: 21px">Optimum class size</p>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div class='backCard invCard0003'>
                                                        <div class="card-container2">
                                                            <p style="text-align: center; padding-top: 200px">
                                                                <a href="Optimum-class-size.php">
                                                                    <button class="btn-hover1">Read More</button>
                                                                </a>
                                                            </p>
                                                        </div>
                                            ...
                                            <div class="portfolio-item">
                                                <div class="card-flip" style="margin-top: 5px">
                                                    <div class='frontCard invCard44'>
                                                        <div class="card-container">
                                                            <div class="container-blue3">
                                                                <p style="font-weight: 600;  color: #FFF;font-size: 21px">Higher Employability</p>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div class='backCard invCard0008'>
                                                        <div class="card-container2">
                                                            <p style="text-align: center; padding-top: 200px">
                                                                <a href="Higher-Employability.php">
                                                                    <button class="btn-hover1">Read More</button>
                                                                </a>
                                                            </p>
                                                        </div>
                            ...
                            <div class="container" style="padding-bottom: 30px">
                                ...
                                <div class="row" style="padding-bottom: 0px">
                                            ...
                                            <div class='frontCard invCard'>
                                                <div class="card-container">
                                                    <div class="container-blue4">
                                                        <h1 style="font-weight: 600;  color: #FFF;font-size: 21px">World class facilities</h1></div>
                                                </div>
                                            </div>

                                            <div class='backCard invCard0005'>
                                                <div class="card-container2">
                                                    <p style="text-align: center; padding-top: 200px">
                                                        <a href="World-class-facilities.php">
                                                            <button class="btn-hover1">Read More</button>
                                                        </a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="col-md-4" style="padding: 5px 5px">
                                        <div class="card-flip">
                                            <div class='frontCard invCard22'>
                                                <div class="card-container">
                                                    <div class="container-blue5">
                                                        <h1 style="font-weight: 600; color: #FFF;font-size: 21px">International expertise</h1></div>
                                                </div>
                                            </div>

                                            <div class='backCard invCard0006'>
                                                <div class="card-container2">
                                                    <p style="text-align: center; padding-top: 200px">
                                                        <a href="International-expertise.php">
                                                            <button class="btn-hover1">Read More</button>
                                                        </a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="col-md-4" style="padding: 5px 5px">
                                        <div class="card-flip">
                                            <div class='frontCard invCard33'>
                                                <div class="card-container">
                                                    <div class="container-blue6">
                                                        <h1 style="font-weight: 600; color: #FFF;font-size: 21px">Gain employability skills</h1></div>
                                                </div>
                                            </div>

                                            <div class='backCard invCard0007'>
                                                <div class="card-container2">
                                                    <p style="text-align: center; padding-top: 200px">
                                                        <a href="Gain-employability-skills.php">
                                                            <button class="btn-hover1">Read More</button>
                                                        </a>
                                                    </p>
                                                </div>
                        ...
                        <script>
                          const second = 1000,
                            ...
                            let countDown = new Date('{date('M d, Y H:i:s', strtotime($hm->intake1_sl))}').getTime(),
                        ...
                        <script>
                            ...
                            let countDowns = new Date('{date('M d, Y H:i:s', strtotime($hm->intake1_in))}').getTime(),
                        ...
                        <script>
                            ...
                            let countDowns124 = new Date('<?php echo e(date('M d, Y H:i:s', strtotime($hm->intake2_sl))); ?>').getTime();
                        ...
                        <script>
                            ...
                            let countDowns125 = new Date('<?php echo e(date('M d, Y H:i:s', strtotime($hm->intake2_in))); ?>').getTime();
                ...
                <div role="main" class="main">
                    ...
                    <div class="container" style="padding-top: 0px; display: grid;">
                        ...
                        <script>
                            ...
                            let countDown = new Date('<?php echo e(date('M d, Y', strtotime($hm->intake1_sl))); ?>').getTime(),
                                x = setInterval(function() {
                        ...
                        <script>
                            ...
                            let countDowns = new Date('<?php echo e(date('M d, Y', strtotime($hm->intake1_in))); ?>').getTime(),
                                y = setInterval(function() {
                        ...
                        <script>
                            ...
                            let countDowns12 = new Date('<?php echo e(date('M d, Y H:i:s', strtotime($hm->intake1_sl))); ?>').getTime();
                        ...
                        <script>
                            ...
                            let countDowns123 = new Date('<?php echo e(date('M d, Y H:i:s', strtotime($hm->intake1_in))); ?>').getTime();
                        ...
                        <script>
                            ...
                            let countDowns127 = new Date('<?php echo e(date('M d, Y H:i:s', strtotime($hm->intake2_sl))); ?>').getTime();
                        ...
                        <script>
                            ...
                            let countDowns128 = new Date('<?php echo e(date('M d, Y H:i:s', strtotime($hm->intake2_in))); ?>').getTime();
                        ...
                        <div class="row align-items-center">
                                        ...
                                        <div class="post-content">
                                            <p style="text-align: center;">
                                                <a href="<?php echo e(url('news')); ?>">
                                                    <img src="<?php echo e(static_asset('theme/img/cvr-news-new.png')); ?>" class="img-fluid img-thumbnail img-thumbnail-no-borders" alt="" style="border-radius: 50px" />
                                                </a>
                                            </p>

                                            <h1 style="padding-top: 20px; color: #FFF; text-align: center; font-weight: bolder;">Read more about CIRP </br> in Media</h1>
                                        ...
                                        <div class="post-content">
                                            <p style="text-align: center;">
                                                <a href="<?php echo e(url('events')); ?>" style="border-radius: 50px;">
                                                    <img src="<?php echo e(static_asset('theme/img/cvr-news3.png')); ?>" class="img-fluid img-thumbnail img-thumbnail-no-borders" alt="" style="border-radius: 50px" />
                                                </a>
                                            </p>

                                            <h1 style="padding-top: 20px; color: #FFF; text-align: center; font-weight: bolder;">CIRP Graduation </br>2019</h1>
                            ...
                            <div class="mobi-cvr">
                                <a href="#" onclick="lightbox_open();">
                                    <img src="<?php echo e(static_asset('theme/img/vbanner.jpg')); ?>" class="img-fluid img-thumbnail img-thumbnail-no-borders" alt="" width="100%" /></a>
                            </div>

                            <div class="desktop-cvr">
                                <a href="#" onclick="lightbox_open();">
                                    <img src="<?php echo e(static_asset('theme/img/video-banner2.png')); ?>" class="img-fluid img-thumbnail img-thumbnail-no-borders" alt="" width="100%" /></a>
                            </div>
                ...
                <div id="light">
                    ...
                    <video id="VisaChipCardVideo" width="800" controls height="600">
                        <source src="<?php echo e(static_asset('theme/video/videoplayback.mp4')); ?>" type="video/mp4">
                            ...
                            <div class="col">
                                <div class="owl-carousel owl-theme mb-0" data-plugin-options="{'responsive': {'0': {'items': 1}, '476': {'items': 1}, '768': {'items': 5}, '992': {'items': 5}, '1200': {'items': 5}}, 'autoplay': true, 'autoplayTimeout': 3000, 'dots': false}">
                                    <div style="margin: 0px 20px">
                                        <a href="https://aru.ac.uk/" target="_blank"><img class="img-fluid" src="<?php echo e(static_asset('theme/img/logos/logo-1.png')); ?>" alt=""></a>
                                    </div>
                                    <div style="margin: 0px 20px">
                                        <a href="https://www.deakin.edu.au/" target="_blank"><img class="img-fluid" src="<?php echo e(static_asset('theme/img/logos/logo-3.png')); ?>" alt=""></a>
                                    </div>
                                    <div style="margin: 0px 20px">
                                        <a href="https://www.ecu.edu.au/" target="_blank"><img class="img-fluid" src="<?php echo e(static_asset('theme/img/logos/logo-4.png')); ?>" alt=""></a>
                                    </div>
                                    <div style="margin: 0px 20px">
                                        <a href="https://www.flinders.edu.au/" target="_blank"><img class="img-fluid" src="<?php echo e(static_asset('theme/img/logos/logo-5.png')); ?>" alt=""></a>
                                    </div>
                                    <div style="margin: 0px 20px">
                                        <a href="https://imi-luzern.com/" target="_blank"><img class="img-fluid" src="<?php echo e(static_asset('theme/img/logos/logo-6.png')); ?>" alt=""></a>
                                    </div>
                                    <div style="margin: 0px 20px">
                                        <a href="https://www.psb-academy.edu.sg/" target="_blank"><img class="img-fluid" src="<?php echo e(static_asset('theme/img/logos/logo-8.png')); ?>" alt=""></a>
                                    </div>
                                    <div style="margin: 0px 20px">
                                        <a href="https://stac.edu.au/" target="_blank"><img class="img-fluid" src="<?php echo e(static_asset('theme/img/logos/logo-9.png')); ?>" alt=""></a>
                                    </div>
                                    <div style="margin: 0px 20px">
                                        <a href="https://www.bolton.ac.uk/" target="_blank"><img class="img-fluid" src="<?php echo e(static_asset('theme/img/logos/logo-10.png')); ?>" alt=""></a>
                                    </div>
                                    <div style="margin: 0px 20px">
                                        <a href="https://www.herts.ac.uk/" target="_blank"><img class="img-fluid" src="<?php echo e(static_asset('theme/img/logos/logo-11.png')); ?>" alt=""></a>
                                    </div>
                                    <div style="margin: 0px 20px">
                                        <a href="https://www.northampton.ac.uk/" target="_blank"><img class="img-fluid" src="<?php echo e(static_asset('theme/img/logos/logo-12.png')); ?>" alt=""></a>
                                    </div>
                                    <div style="margin: 0px 20px">
                                        <a href="https://www.utas.edu.au/" target="_blank"><img class="img-fluid" src="<?php echo e(static_asset('theme/img/logos/logo-13.png')); ?>" alt=""></a>
                                    </div>
                                    <div style="margin: 0px 20px">
                                        <a href="https://www.uwa.edu.au/" target="_blank"><img class="img-fluid" src="<?php echo e(static_asset('theme/img/logos/logo-14.png')); ?>" alt=""></a>
                                    </div>
                                    <div style="margin: 0px 20px">
                                        <a href="https://www.weltec.ac.nz/" target="_blank"><img class="img-fluid" src="<?php echo e(static_asset('theme/img/logos/logo-16.png')); ?>" alt=""></a>
                                    </div>
                                    <div style="margin: 0px 20px">
                                        <a href="https://www.whitireia.ac.nz/" target="_blank"><img class="img-fluid" src="<?php echo e(static_asset('theme/img/logos/logo-18.png')); ?>" alt=""></a>
                                    </div>
                                    <div style="margin: 0px 20px">
                                        <a href="https://www.westernsydney.edu.au/" target="_blank"><img class="img-fluid" src="<?php echo e(static_asset('theme/img/logos/logo-17.png')); ?>" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('site::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /shared/httpd/cirb/htdocs/Modules/Site/Providers/../Resources/views/index.blade.php ENDPATH**/ ?>