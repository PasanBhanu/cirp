					...
					<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'sliderLayout': 'fullscreen', 'delay': 9000, 'gridwidth': 1170, 'gridheight': 1000, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1200,992,500], }">
						<ul>
							<li data-transition="fade">
								<img src="<?php echo e(static_asset('theme/video/37.png')); ?>"  
								alt=""
								...
								<div class="row">
								    ...
								    <div class="col-md-4">
										<article class="post post-medium border-0 pb-0 mb-5" style="background-color: #c1c1c11f;padding: 5px 5px;">
											<div class="post-image">
												<a>
													<img src="<?php echo e(static_asset('theme/img/media/05.png')); ?>" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt=""/>
												</a>
											</div>
											...
											<div class="post-content">
												...
												<div class="post-meta">
													<p><span class="d-block mt-2"><a href="<?php echo e(static_asset('theme/img/media/Sunday Times - Page 05.jpg')); ?>" class="btn btn-xs btn-light text-1 text-uppercase">Read More</a></span></p>
												</div>
									...
									<div class="col-md-4">
										<article class="post post-medium border-0 pb-0 mb-5" style="background-color: #c1c1c11f;padding: 5px 5px;">
											<div class="post-image">
												<a>
													<img src="<?php echo e(static_asset('theme/img/media/9.png')); ?>" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt="" />
												</a>
											</div>
											...
											<div class="post-content">
												...
												<div class="post-meta">
													...
													<span class="d-block mt-2"><a href="<?php echo e(static_asset('theme/img/media/Sunday Times - Page 09.jpg')); ?>" class="btn btn-xs btn-light text-1 text-uppercase">Read More</a></span>
												</div>
									...
									<div class="col-md-4">
										<article class="post post-medium border-0 pb-0 mb-5"  style="background-color: #c1c1c11f;padding: 5px 5px;">
											<div class="post-image">
												<a>
													<img src="<?php echo e(static_asset('theme/img/media/11.png')); ?>" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt=""/>
												</a>
											</div>
											...
											<div class="post-content">
												...
												<div class="post-meta">
													<span class="d-block mt-2"><a href="<?php echo e(static_asset('theme/img/media/Sunday Times - Page 11.jpg')); ?>" class="btn btn-xs btn-light text-1 text-uppercase">Read More</a></span>
												</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('site::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /shared/httpd/cirp/htdocs/Modules/Site/Providers/../Resources/views/news.blade.php ENDPATH**/ ?>