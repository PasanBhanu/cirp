...
<div class="dashboard-header">
        <nav class="navbar navbar-expand-lg bg-white fixed-top">
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto navbar-right-top">
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-user-img" href="https://www.ewisnet.com" target="_bln_ewisnet">
                            <img src="<?php echo e(static_asset('images/favicon.ico')); ?>" class="user-avatar-md rounded-circle">
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <!-- end navbar -->
    <!-- ============================================================== -->
<?php /**PATH /shared/httpd/cirb/htdocs/Modules/Common/Providers/../Resources/views/layouts/header.blade.php ENDPATH**/ ?>