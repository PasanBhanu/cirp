					...
					<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'sliderLayout': 'fullscreen', 'delay': 9000, 'gridwidth': 1170, 'gridheight': 1000, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1200,992,500],}">
						<ul>
							<li data-transition="fade">
								<img src="<?php echo e(static_asset('theme/video/24.png')); ?>"  
								alt=""
								...
								<div class="row">
									...
									<div class="col-md-4">
										<article class="post post-medium border-0 pb-0 mb-5" style="background-color: #c1c1c11f;padding: 5px 5px;">
											<div class="post-image">
												<a>
													<img src="<?php echo e(static_asset('theme/img/cvr-news.png')); ?>" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt=""/>
												</a>
											</div>
									...
									<div class="col-md-4">
										<article class="post post-medium border-0 pb-0 mb-5" style="background-color: #c1c1c11f;padding: 5px 5px;">
											<div class="post-image">
												<a>
													<img src="<?php echo e(static_asset('theme/img/cvr-news2.png')); ?>" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt="" />
												</a>
											</div>
									...
									<div class="col-md-4">
										<article class="post post-medium border-0 pb-0 mb-5"  style="background-color: #c1c1c11f;padding: 5px 5px;">
											<div class="post-image">
												<a>
													<img src="<?php echo e(static_asset('theme/img/events/Mental Health 2019/cvr.png')); ?>" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt=""/>
												</a>
											</div>
									...
									<div class="col-md-4">
										<article class="post post-medium border-0 pb-0 mb-5"  style="background-color: #c1c1c11f;padding: 5px 5px;">
											<div class="post-image">
												<a>
													<img src="<?php echo e(static_asset('theme/img/events/2019 Iftar/1.png')); ?>" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt="" />
												</a>
											</div>
									...
									<div class="col-md-4">
										<article class="post post-medium border-0 pb-0 mb-5"  style="background-color: #c1c1c11f;padding: 5px 5px;">
											<div class="post-image">
												<a>
													<img src="<?php echo e(static_asset('theme/img/events/Graduation 2017-2018/1.png')); ?>" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt="" />
												</a>
											</div>
									...
									<div class="col-md-4">
										<article class="post post-medium border-0 pb-0 mb-5"  style="background-color: #c1c1c11f;padding: 5px 5px;">
											<div class="post-image">
												<a>
													<img src="<?php echo e(static_asset('theme/img/events/Talent Show/1.png')); ?>" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt="" />
												</a>
											</div>
									...
									<div class="col-md-4">
										<article class="post post-medium border-0 pb-0 mb-5"  style="background-color: #c1c1c11f;padding: 5px 5px;">
											<div class="post-image">
												<a>
													<img src="<?php echo e(static_asset('theme/img/events/winter wonderland 2017/1.png')); ?>" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt="" />
												</a>
											</div>
									...
									<div class="col-md-4">
										<article class="post post-medium border-0 pb-0 mb-5"  style="background-color: #c1c1c11f;padding: 5px 5px;">
											<div class="post-image">
												<a>
													<img src="<?php echo e(static_asset('theme/img/cvr-news3.png')); ?>" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt="" />
												</a>
											</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('site::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /shared/httpd/cirp/htdocs/Modules/Site/Providers/../Resources/views/events.blade.php ENDPATH**/ ?>