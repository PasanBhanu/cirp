                    ...
                    <div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'sliderLayout': 'fullscreen', 'delay': 9000, 'gridwidth': 1170, 'gridheight': 1000, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1200,992,500],}">
                        <ul>
                            <li data-transition="fade">
                                <img src="{{static_asset('theme/video/21.png')}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg">
                                ...
                                <div class="col-lg-3">
                                    <aside class="sidebar">
                                        ...
                                        <ul class="nav nav-list flex-column mb-4 show-bg-active">
                                            <a href="#"><img src="{{static_asset('theme/img/alumni.png')}}" height="250px" width="250px" /></a>
                                        </ul>
                                    </aside>
                                    ...
                                    <div class="carousel-inner row w-100 mx-auto">
                                            ...
                                            <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="0">
                                                <div class="thumb-info thumb-info-no-zoom thumb-info-custom mb-5 text-center">
                                                    <div class="thumb-info-side-image-wrapper p-0">
                                                        <img src="{{static_asset('theme/img/testimonial/01.png')}}" class="img-fluid" alt="">
                                        ...
                                        <div class="carousel-item col-md-4">
                                            <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="0">
                                                <div class="thumb-info thumb-info-no-zoom thumb-info-custom mb-5 text-center">
                                                    <div class="thumb-info-side-image-wrapper p-0">
                                                        <img src="{{static_asset('theme/img/testimonial/02.png')}}" class="img-fluid" alt="">
                                        ...
                                        <div class="carousel-item col-md-4">
                                            <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="0">
                                                <div class="thumb-info thumb-info-no-zoom thumb-info-custom mb-5 text-center">
                                                    <div class="thumb-info-side-image-wrapper p-0">
                                                        <img src="{{static_asset('theme/img/testimonial/03.png')}}" class="img-fluid" alt="">
                                        ...
                                        <div class="carousel-item col-md-4">
                                            <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="0">
                                                <div class="thumb-info thumb-info-no-zoom thumb-info-custom mb-5 text-center">
                                                    <div class="thumb-info-side-image-wrapper p-0">
                                                        <img src="{{static_asset('theme/img/testimonial/04.png')}}" class="img-fluid" alt="">
                                        ...
                                        <div class="carousel-item col-md-4">
                                            <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="0">
                                                <div class="thumb-info thumb-info-no-zoom thumb-info-custom mb-5 text-center">
                                                    <div class="thumb-info-side-image-wrapper p-0">
                                                        <img src="{{static_asset('theme/img/testimonial/05.png')}}" class="img-fluid" alt="">
                                        ...
                                        <div class="carousel-item col-md-4">
                                            <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="0">
                                                <div class="thumb-info thumb-info-no-zoom thumb-info-custom mb-5 text-center">
                                                    <div class="thumb-info-side-image-wrapper p-0">
                                                        <img src="{{static_asset('theme/img/testimonial/06.png')}}" class="img-fluid" alt="">
                                        ...
                                        <div class="carousel-item col-md-4">
                                            ...
                                            <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="0">
                                                <div class="thumb-info thumb-info-no-zoom thumb-info-custom mb-5 text-center">
                                                    <div class="thumb-info-side-image-wrapper p-0">
                                                        <img src="{{static_asset('theme/img/testimonial/07.png')}}" class="img-fluid" alt="">
                                ...
                                <div class="top">
                                    <div class="cta cta1">
                                        <figure class="gallery-image">
                                            <img src="{{static_asset('theme/img/projects/alumni/alumni1.jpg')}}" />
                                        </figure>
                                    </div>
                                    <div class="cta cta2">
                                        <figure class="gallery-image">
                                            <img src="{{static_asset('theme/img/projects/alumni/alumni2.png')}}" />
                                        </figure>
                                    </div>
                                    <header class="hero">
                                        <figure class="gallery-image">
                                            <img src="{{static_asset('theme/img/projects/alumni/alumni3.png')}}" />
                                        </figure>
                                    </header>

                                    <div class="cta cta3">
                                        <figure class="gallery-image">
                                            <img src="{{static_asset('theme/img/projects/alumni/alumni4.jpg')}}" />
                                        </figure>
                                    </div>
                                    <div class="cta cta4">
                                        <figure class="gallery-image">
                                            <img src="{{static_asset('theme/img/projects/alumni/alumni5.png')}}" />
                                        </figure>
                                    </div>
