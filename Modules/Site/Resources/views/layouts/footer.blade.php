        ...
        <div class="row py-5">
            <div class="col-6 col-lg-4 mb-5 mb-lg-0">
                ...
                <ul class="list list-icons list-icons-sm">
                    ...
                    <li style="display: inline; color: #222;"><a  style="color: #222;">{{ settingHelper('address') }}</br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Sri Lanka.</a></li>
                    </br>
                    <li class=" mb-0 icon-call-out icons" style="display: inline;"></li>
                    <li style="display: inline;"><a  style="color: #222;">{{ settingHelper('phone') }}</a></li>
                    </br>
                    <li class=" mb-0 far fa-envelope" style="display: inline;"></li>
                    <li style="display: inline;"><a  style="color: #222;"> {{ settingHelper('email') }}</a></li>
                    </br>
            ...
            <div class="col-6 col-lg-2 mb-5 mb-lg-0">
                ...
                <ul class="list list-icons list-icons-sm">
                     <!-- <li><i class="fas fa-angle-right"></i><a href="{{url('courses')}}" class="link-hover-style-1 ml-1"  style="color: #222;"> Courses</a></li> -->
            ...
            <div class="col-6 col-lg-2 mb-5 mb-lg-0">
                ...
                <ul class="list list-icons list-icons-sm">
                    <li><i class="fas fa-angle-right"></i><a href="{{url('about-CIIHE')}}" class="link-hover-style-1 ml-1"  style="color: #222;"> About us</a></li>
                   <li><i class="fas fa-angle-right"></i><a href="{{url('courses')}}" class="link-hover-style-1 ml-1"  style="color: #222;"> Courses</a></li>
                    ...
                    <li><i class="fas fa-angle-right"></i><a href="{{url('contactus')}}" class="link-hover-style-1 ml-1"  style="color: #222;"> Contact us</a></li>
                </ul>
            </div>
            ...
            <div class="col-6 col-lg-4 mb-5 mb-lg-0">
                ...
                <form action="{{ route('subscribe.newsletter') }}" method="POST" class="mw-100">
                    @csrf
        ...
        <div class="container py-2">
            <div class="row py-4">
                <div class="col-lg-7 d-flex align-items-center justify-content-center justify-content-lg-start mb-4 mb-lg-0">
                    @php $v=base64_decode('PHA+Q29weXJpZ2h0ICZjb3B5OyBDSVJQIDIwMjEuIEFMTCBSSUdIVFMgUkVTRVJWRUQgfCBQb3dlcmVkIGJ5IDxhIGhyZWY9Imh0dHBzOi8vd3d3LmV3aXNuZXQuY29tIiB0YXJnZXQ9Il9ibG5fZXdpIj5Fd2lzbmV0IEludGVybmV0IFNvbHV0aW9uczwvYT48L3A+'); echo $v;@endphp
                </div>
