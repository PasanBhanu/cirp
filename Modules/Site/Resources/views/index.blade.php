            ...
            <div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'sliderLayout': '500px', 'delay': 2000, 'gridwidth': 1170, 'gridheight': 700, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1200,992,500],'parallax': { 'type': 'scroll', 'origo': 'enterpoint', 'speed': 1000, 'levels': [2,3,4,5,6,7,8,9,12,50], 'disable_onmobile': 'on' }}">
                <ul>
                    ...
                    <li data-transition="fade">
                        <img src="{{static_asset($slide->image)}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg">
                        <div class="col-lg-6 pt-4 pt-lg-0 mt-5 mt-lg-0 mb-5 mb-lg-0 hide-feather">
                            <div class="appear-animation with-text-container" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600" style="padding: 210px 0px 0px 0px" class="hide-box">
                                ...
                                <img src="{{static_asset('theme/img/001.png')}}" alt="" width="470px" height="420px" style="margin: 0px 0px 35px 0px">
                                <div class="centered" style="padding: 60px">
                                    <p class=" main-head-t" style="color: #FFFFFF; text-align: left;">{{$slide->title}}</p>
                                    <p class="study-test" style="font-size: 13px; text-align: left;">{{$slide->description}}</p>
                                    <p class="checkout-text" style="text-align: left; font-size: 14px">{{$slide->checkout}}</p>
                                    <p style="text-align: left; display: flex;">
                                        @if(empty($slide->button1_link))
                                        <button class="btn-majors" style="margin-right: 10px">{{$slide->button1_title}}</button>
                                        @else
                                        <a href="{{$slide->button1_link}}">
                                            <button class="btn-majors" style="margin-right: 10px">{{$slide->button1_title}}</button>
                                        </a>
                                        @endif
                                        @if(empty($slide->button2_link))
                                        <button class="btn-majors">{{$slide->button2_title}}</button>
                                        @else
        ...
        <div class="slider-container rev_slider_wrapper" style="height: 100vh;">
            <div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'sliderLayout': 'fullscreen', 'delay': 9000, 'gridwidth': 1170, 'gridheight': 1000, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1200,992,500], 'parallax': { 'type': 'scroll', 'origo': 'enterpoint', 'speed': 1000, 'levels': [2,3,4,5,6,7,8,9,12,50], 'disable_onmobile': 'on' }}">
                <ul>
                    @foreach ($slideshows as $slide)
                    <li data-transition="fade">
                        <img src="{{static_asset($slide->image_m)}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg">
                        <div class="col-lg-6 pt-4 pt-lg-0 mt-5 mt-lg-0 mb-5 mb-lg-0">
                            <div class="appear-animation with-text-container" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400" style="padding: 150px 0px 0px 0px">
                                ...
                                <img src="{{static_asset('theme/img/001.png')}}" alt="" width="470px" height="420px" style="margin: 0px 0px 35px 90px">
                                <div class="centered">
                                    <p class=" main-head-t" style="color: #FFFFFF">{{$slide->title}}</p>
                                    <p class="study-test" style="font-size: 15px">{{$slide->description}}</p>
                                    <p class="checkout-text">{{$slide->checkout}}</p>
                                    <p>
                                        @if(empty($slide->button1_link))
                                        <button class="btn-majors">{{$slide->button1_title}}</button>
                                        @else
                                        <a href="{{$slide->button1_link}}">
                                            <button class="btn-majors">{{$slide->button1_title}}</button>
                                        </a>
    ...
    <div style="background-image: url(public/theme/img/fingerprint.png); background-size: cover; background-position: right;">
        ...
        <div style="background-image: url(public/theme/img/fingerprint.png); background-size: cover; background-position: right;">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12 text-center" style="padding-left: 5px; padding-right: 5px">
                        <img src="{{static_asset($hm->join_image)}}" width="100%" height="100%">
                    </div>
                </div>
            </div>
                        ...
                        <div class="row portfolio-list sort-destination" data-sort-id="portfolio">
                            <div class="col-md-6 isotope-item brands" style="padding: 5px 5px 0px 0px">
                                <div class="card-flip card-flip-change-height1">
                                    <div class='frontCard' style="height: 510px; background-image: url('{{ static_asset('theme/img/tiles/tile-01.png')}}'); background-size: cover;}">
                                        <div class="card-container">
                                            <div>
                                                <h1 style="font-weight: 900; text-align: left; font-size: 46px; line-height: 43px; padding-top: 300px"> {{$tiles[0]->title}} </h1>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class='backCard invCard2' style="background-color: #247cb7">
                                        <div class="card-container2">
                                            <h1 style="color: #FFFFFF; font-weight: bolder;">{{$tiles[0]->text}}</h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3 isotope-item websites" style="padding: 5px 5px">
                                <div class="portfolio-item">
                                    <div class="card-flip" style="margin-bottom: 5px">
                                        <div class='frontCard' style="background-image: url('{{ static_asset('theme/img/tiles/tile-02.png')}}'); background-size: cover;}">
                                            <div class="card-container">
                                                <div class="container-blue2">
                                                    <p style="font-weight: 600;  color: #FFF;font-size: 21px">{{$tiles[1]->title}}</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="portfolio-item">
                                    <div class="card-flip" style="margin-top: 5px">
                                        <div class='frontCard' style="background-image: url('{{ static_asset('theme/img/tiles/tile-03.png')}}'); background-size: cover;}">
                                            <div class="card-container">
                                                <div class="container-blue3">
                                                    <p style="font-weight: 600;  color: #FFF;font-size: 21px"> {{$tiles[2]->title}}</p>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-6 col-lg-3 isotope-item websites" style="padding: 5px 5px">
                                <div class="portfolio-item">
                                    <div class="card-flip" style="margin-bottom: 5px">
                                        <div class='frontCard' style="background-image: url('{{ static_asset('theme/img/tiles/tile-04.png')}}'); background-size: cover;}">
                                            <div class="card-container">
                                                <div class="container-blue2">
                                                    <p style="font-weight: 600;  color: #FFF;font-size: 21px">{{$tiles[3]->title}}</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="portfolio-item">
                                    <div class="card-flip" style="margin-top: 5px">
                                        <div class='frontCard' style="background-image: url('{{ static_asset('theme/img/tiles/tile-05.png')}}'); background-size: cover;}">
                                            <div class="card-container">
                                                <div class="container-blue3">
                                                    <p style="font-weight: 600;  color: #FFF;font-size: 21px"> {{$tiles[4]->title}} </p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="container" style="padding-bottom: 30px">
                    ...
                    <div class="row" style="padding-bottom: 0px">
                        <div class="col-md-4" style="padding: 5px 5px">
                            <div class="card-flip">
                                <div class='frontCard' style="background-image: url('{{ static_asset('theme/img/tiles/tile-06.png')}}'); background-size: cover;}">
                                    <div class="card-container">
                                        <div class="container-blue4">
                                            <h1 style="font-weight: 600;  color: #FFF;font-size: 21px">{{$tiles[5]->title}}</h1>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4" style="padding: 5px 5px">
                            <div class="card-flip">
                                <div class='frontCard' style="background-image: url('{{ static_asset('theme/img/tiles/tile-07.png')}}'); background-size: cover;}">
                                    <div class="card-container">
                                        <div class="container-blue5">
                                            <h1 style="font-weight: 600; color: #FFF;font-size: 21px"> {{$tiles[6]->title}}</h1>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4" style="padding: 5px 5px">
                            <div class="card-flip">
                                <div class='frontCard' style="background-image: url('{{ static_asset('theme/img/tiles/tile-08.png')}}'); background-size: cover;}">
                                    <div class="card-container">
                                        <div class="container-blue6">
                                            <h1 style="font-weight: 600; color: #FFF;font-size: 21px"> {{$tiles[7]->title}} </h1>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6" style="padding: 5px 5px">
                            <div class="card-flip">
                                <div class='frontCard' style="background-image: url('{{ static_asset('theme/img/tiles/tile-06.png')}}'); background-size: cover;}">
                                    <div class="card-container">
                                        <div class="container-blue2">
                                            <p style="font-weight: 600;  color: #FFF;font-size: 21px">{{$tiles[5]->title}}</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6" style="padding: 5px 5px">
                            <div class="card-flip">
                                <div class='frontCard' style="background-image: url('{{ static_asset('theme/img/tiles/tile-07.png')}}'); background-size: cover;}">
                                    <div class="card-container">
                                        <div class="container-blue2">
                                            <p style="font-weight: 600;  color: #FFF;font-size: 21px">{{$tiles[6]->title}}</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6" style="padding: 5px 5px">
                            <div class="card-flip">
                                <div class='frontCard' style="background-image: url('{{ static_asset('theme/img/tiles/tile-08.png')}}'); background-size: cover;}">
                                    <div class="card-container">
                                        <div class="container-blue2">
                                            <p style="font-weight: 600;  color: #FFF;font-size: 21px">{{$tiles[7]->title}}</p>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container reg-desktop" style="background-color: #393636; border-radius: 60px 0px" style="padding-top: 0px">
                ...
                <table style="margin: 10px 0px;">
                    <tbody>
                        ...
                        <tr>
                            <th rowspan="5"><img src="{{static_asset('theme/img/txt.png')}}" width="260px" height="75px" style="padding: 0px 25px 0px 0px"></th>
                            <td>> {{date('M Y', strtotime($hm->intake1_sl))}} Intake</td>
                            <td>> Sri Lankan Students</td>
                            <td>> {{date('M d, Y', strtotime($hm->intake1_sl))}}</td>
                        ...
                        <tr>
                            ...
                            <td>> {{date('M d, Y', strtotime($hm->intake1_in))}}</td>
                            <td id="demo" style="color: #ffb301">
                        ...
                        <tr>
                            <td colspan="4"><img src="{{static_asset('theme/img/hr.png')}}" width="800px"></td>
                        </tr>
                        <tr>
                            <td>> September 2021 Intake</td>
                            <td>> Sri Lankan Students</td>
                            <td>> {{date('M d, Y', strtotime($hm->intake2_sl))}}</td>
                            <td id="demo" style="color: #ffb301">
                        ...
                        <tr>
                            <td></td>
                            <td>> International Students</td>
                            <td>> {{date('M d, Y', strtotime($hm->intake2_in))}}</td>
                            <td id="demo" style="color: #ffb301">
            ...
            <script>
                ...
                let countDowns124 = new Date('{{date('
            ...
            <script>
                ...
                let countDowns125 = new Date('{{date('
                            ...
                            <div class=" bg-transparent text-center rounded-0">
                                <div class="flip-back d-flex align-items-center p-5" style="background-image: url(public/theme/img/banner2.png); background-size: cover; background-position: center;">
                                    <div class="flip-content my-4">
                                        ...
                                        <a href="{{static_asset('theme/img/pdf/CIIHE - Application Form.pdf')}}">
    ...
    <div role="main" class="main">
        ...
        <div class="container" style="padding-top: 0px; display: grid;">
            ...
            <div class="container reg-mobi" style="background-color: #393636; border-radius: 0px 0px; padding: 80px 0px">
                <div class="col-lg-offset-1">
                    ...
                    <div style="padding-bottom: 80px">
                        <p style="text-align: center;"><img src="{{static_asset('theme/img/txt.png')}}"></p>
                    </div>

                    <ul class="list list-icons mt-4 mb-4">
                        <li>
                            <p class="mobi-reg-text">{{date('M Y', strtotime($hm->intake1))}} Intake</p>
                        </li>

                        <li class="mobi-reg-text-2">Sri Lankan Students &nbsp;&nbsp;>&nbsp;&nbsp; {{date('M d, Y', strtotime($hm->intake1_sl))}}</li>
                    ...
                    <ul class="list list-icons mt-4 mb-4">
                        ...
                        <li class="mobi-reg-text-2">International Students &nbsp;&nbsp;>&nbsp;&nbsp; {{date('M d, Y', strtotime($hm->intake1_in))}}</li>
                        <li style="text-align: center;">
                            <p id="demo" style="color: #ffb301">
                        ...
                        <li style="text-align: center"><img src="{{static_asset('theme/img/hr2.png')}}"></li>

                    </ul>

                    <ul class="list list-icons mt-4 mb-4">
                        <li>
                            <p class="mobi-reg-text">{{date('M Y', strtotime($hm->intake2))}} Intake</p>
                        </li>

                        <li class="mobi-reg-text-2">Sri Lankan Students &nbsp;&nbsp;>&nbsp;&nbsp; {{date('M d, Y', strtotime($hm->intake2_sl))}}</li>
                        <li style="text-align: center;">
                            <p id="demo" style="color: #ffb301">
                    ...
                    <ul class="list list-icons mt-4 mb-4">
                        ...
                        <li class="mobi-reg-text-2">International Students &nbsp;&nbsp;>&nbsp;&nbsp; {{date('M d, Y', strtotime($hm->intake2_in))}}</li>
                        <li style="text-align: center;">
                            <p id="demo" style="color: #ffb301">
            ...
            <script>
                ...
                let countDowns12 = new Date('{{date('
                    M d, Y H: i: s ', strtotime($hm->intake1_sl))}}').getTime();
            ...
            <script>
                ...
                let countDowns123 = new Date('{{date('
                    M d, Y H: i: s ', strtotime($hm->intake1_in))}}').getTime();
            ...
            <script>
                ...
                let countDowns127 = new Date('{{date('
                    M d, Y H: i: s ', strtotime($hm->intake2_sl))}}').getTime();
            ...
            <script>
                ...
                let countDowns128 = new Date('{{date('
                    M d, Y H: i: s ', strtotime($hm->intake2_in))}}').getTime();
            ...
            <div class="row align-items-center">
                        ...
                        <article class="post post-medium border-0 pb-0 mb-5">
                            ...
                            <div class="post-content">
                                <p style="text-align: center;">
                                    <a href="{{url('news')}}">
                                        <img src="{{static_asset($media[0]->image)}}" class="img-fluid img-thumbnail img-thumbnail-no-borders" alt="" style="border-radius: 50px" />
                                    </a>
                                </p>

                                <h1 style="padding-top: 20px; color: #FFF; text-align: center; font-weight: bolder;"> {{$media[0]->title}} </h1>
                ...
                <div class="col-lg-6 pl-lg-5" style="background-image: url(public/theme/img/01.png); background-size: cover; background-position: center;">
                    <div class="col-md-12 col-lg-12">
                        <article class="post post-medium border-0 pb-0 mb-5">
                            ...
                            <div class="post-content">
                                <p style="text-align: center;">
                                    <a href="{{url('events')}}" style="border-radius: 50px;">
                                        <img src="{{static_asset($media[1]->image)}}" class="img-fluid img-thumbnail img-thumbnail-no-borders" alt="" style="border-radius: 50px" />
                                    </a>
                                </p>

                                <h1 style="padding-top: 20px; color: #FFF; text-align: center; font-weight: bolder;">{{$media[1]->title}} </h1>
                ...
                <div class="mobi-cvr">
                    <a href="#" onclick="lightbox_open();">
                        <img src="{{static_asset($video[0]->video_thumbnail)}}" class="img-fluid img-thumbnail img-thumbnail-no-borders" alt="" width="100%" /></a>
                </div>

                <div class="desktop-cvr">
                    <a href="#" onclick="lightbox_open();">
                        <img src="{{static_asset($video[0]->mobile_thumbnail)}}" class="img-fluid img-thumbnail img-thumbnail-no-borders" alt="" width="100%" /></a>
                </div>
                ...
                <div class="col">
                    <div class="owl-carousel owl-theme mb-0" data-plugin-options="{'responsive': {'0': {'items': 1}, '476': {'items': 1}, '768': {'items': 5}, '992': {'items': 5}, '1200': {'items': 5}}, 'autoplay': true, 'autoplayTimeout': 3000, 'dots': false}">
                        ...
                        <div style="margin: 0px 20px">
                            <a href="{{$logo->link}}" target="_blank"><img class="img-fluid" src="{{static_asset($logo->image)}}" alt=""></a>
                        </div>
                        @endforeach
                    </div>
                </div>
