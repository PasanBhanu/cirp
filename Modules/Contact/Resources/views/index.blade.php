                                                ...
                                                <tr role="row" id="row_{{ $contactMessage->id }}" class="odd">
                                                    ...
                                                    <td>
                                                            <a href="javascript:void(0)" class="modal-menu btn btn-light active btn-xs"
                                                                ...
                                                                data-toggle="modal"
                                                                data-target="#common-modal{{ $contactMessage->id }}"><i
                                                                class="fa fa-eye"></i>
                                                                {{ __('view') }}
                                                            </a>
...
@section('modal')
@foreach($contactMessages as $contactMessage)
    <div id="common-modal{{ $contactMessage->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content p-0 b-0">
                <div class="panel panel-color panel-primary">
                    <div class="modal-header">
                        
                        <h5 class="modal-title" id="common-modal-title">{{$contactMessage->subject}} </h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <label for="name" class="col-form-label col-md-12"><b>{{ $contactMessage->name }}</b> {{$contactMessage->email }}</label>
                            <div class="col-md-12">
                                <textarea disabled rows="10" class="form-control">{{$contactMessage->message }}</textarea>
                            </div>
                        </div>
                    </div>
