...
Route::group(
    ...
    Route::prefix('contact')->group(function() {
        Route::group(['middleware' => ['loginCheck', 'XSS']], function () {
            ...
            Route::get('inquiries','ContactController@inquiries');
            Route::get('application','ContactController@appplication');

            Route::get('application/view/{id}','ContactController@view');
